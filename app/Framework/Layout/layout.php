...
<!--    <script src="--><?php //echo $this->getBP() ?><!--/js/slider.js"></script>-->
<!--    <script src="--><?php //echo $this->getBP() ?><!--/js/input.js"></script>-->
<!--    <script src="--><?php //echo $this->getBP() ?><!--/js/upload.js"></script>-->
